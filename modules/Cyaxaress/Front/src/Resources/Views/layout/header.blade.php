        ...
        <div class="t-header-row">
                            ...
                            <div class="t-header-search-result">
                                <a href="">
                                    <div class="t-header-search-result-right">
                                        <p>Course on building a framework similar to Laravel</p>
                                        <p class="t-header-search-result-right-info">
                                            Course instructor: Hemn Movaqeqi
                                        </p>
                                    </div>
            ...
            <div class="t-header-left">
                ...
                <div class="join-teachers">
                    <a href="become-a-teacher.html">Teach at Hemn_org</a>
                </div>
                @auth()
    ...
    <nav id="navigation" class="navigation">
        ...
        <div class="container">
            <ul class="nav">
                ...
                <li class="main-menu join-teachers-li"><a href="become-a-teacher.html">Teach at Hemn_org</a></li>
                <li class="main-menu"><a href="https://www.webamooz.net/blog">Articles</a></li>
            </ul>
