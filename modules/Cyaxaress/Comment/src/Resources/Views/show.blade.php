...
@section('content')
    <div class="main-content">
        ...
        <div class="answer-comment">
            <p class="p-answer-comment">Submit a reply</p>
            ...
            <form action="{{ route("comments.store") }}" method="post">
                ...
                <x-text-area name="body" placeholder="Submit a comment..."/>
                <button type="submit" class="btn btn-webamooz_net">Submit reply</button>
            </form>
            @else
                <p class="text-error">To submit a reply to this comment, please approve it first.</p>
            @endif
        </div>
    </div>
@endsection
